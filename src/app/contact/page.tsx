  ...
  return (
    <div className="bg-white text-slate-950 font-inter selection:bg-forest-green selection:text-white">
      ...
      <section className="py-16 lg:py-20 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <FadeIn delay={0.12} className="flex flex-col gap-6">
            ...
            <a href="tel:+61423483555" className="group flex flex-col p-8 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md hover:border-forest-green/30 transition-all">
      ...
      <section className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100">
        ...
        <FadeIn>
          <div className="w-full rounded-2xl overflow-hidden shadow-[0_26px_60px_-26px_rgba(5,10,7,0.4)] aspect-[16/9] sm:aspect-[21/9]">
            <iframe
