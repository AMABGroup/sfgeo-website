      ...
      <section className="pt-32 pb-16 px-6 lg:px-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 pb-10 border-b border-gray-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <span className="text-xs font-semibold text-slate-950 tracking-wide uppercase">Connect on LinkedIn</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-xs font-semibold text-slate-950 tracking-wide uppercase">Follow on Instagram</span>
            </a>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-8 border-t border-gray-200/60">
              ...
              <div>
                ...
                <div className="flex flex-col gap-1 text-base text-slate-950">
                  ...
                  <p className="font-medium">Sat–Sun: <span className="font-light text-gray-500 ml-1">8:00 AM – 2:00 PM</span></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col h-full group">
            <div className="bg-slate-950 rounded-3xl p-8 sm:p-12 shadow-xl flex flex-col justify-center h-full relative overflow-hidden ring-1 ring-white/10 transition-all hover:ring-white/20">
              ...
              <div className="relative z-10 flex flex-col items-start">
                ...
                <h3 className="text-3xl sm:text-4xl font-montserrat font-semibold text-white mb-6 leading-tight max-w-sm">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  ...
                  <a 
                    href="#" 
                    className="flex justify-center items-center px-8 py-4 bg-white/5 text-white font-semibold rounded-full border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all hover:-translate-y-1"
                  >
                    Leave a Review
                  </a>
                </div>
