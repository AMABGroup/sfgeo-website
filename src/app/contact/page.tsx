              ...
              <div className="relative z-10 flex flex-col items-start">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex justify-center items-center px-8 py-2.5 bg-forest-green text-white text-xs font-semibold rounded-full shadow-lg shadow-forest-green/20 hover:bg-forest-green/90 transition-all hover:-translate-y-0.5 h-[46px]"
                  >
                    Read Our Reviews
                  </a>
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex justify-center items-center px-8 py-2.5 bg-white text-forest-green text-xs font-semibold rounded-full border border-forest-green/20 hover:bg-forest-green/10 hover:border-forest-green/30 transition-all hover:-translate-y-0.5 h-[46px]"
                  >
                    Leave a Review
                  </a>
                </div>
