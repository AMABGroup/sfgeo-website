            ...
            <div data-stagger style={d(120)} className="flex flex-col gap-6">
              ...
              <div className={CARD}>
                ...
                <p className="text-[15px] text-gray-600 font-light leading-relaxed mb-6">
                  The Principal reads every enquiry. Fieldwork is scheduled at first contact, and on a clear classification the report can land as soon as 2 business days after it.
                </p>
