    ...
    <div className="bg-white text-slate-black font-inter min-h-screen">
      <section className="pt-32 pb-16 px-6 lg:px-12 max-w-7xl mx-auto">
        <motion.div initial="hidden" animate="visible" variants={stagger}>
          ...
          <motion.h1
            variants={fadeIn}
            className="text-4xl sm:text-5xl font-montserrat font-bold tracking-tight text-slate-black max-w-4xl mb-6"
          >
          ...
          <motion.p variants={fadeIn} className="text-xl text-gray-500 font-light leading-relaxed max-w-2xl mb-16">
            Get in touch for specialised geotechnical insights and reliable on-site engineering support across the Sydney Metro.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-16">
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger} className="flex flex-col gap-10">
            <motion.div variants={fadeIn}>
              <h4 className="text-sm font-bold tracking-wider text-slate-black uppercase mb-3 border-b border-forest-green pb-2 inline-block">Office Location</h4>
              <p className="text-gray-600 font-light">
                <strong className="font-semibold text-slate-black">Level 3, 107 Sydenham Road</strong><br />
                Marrickville, NSW 2204
              </p>
            </motion.div>

            <motion.div variants={fadeIn}>
              <h4 className="text-sm font-bold tracking-wider text-slate-black uppercase mb-3 border-b border-forest-green pb-2 inline-block">Trading Hours</h4>
              <p className="text-gray-600 font-light flex flex-col gap-1">
                <span><strong className="font-semibold text-slate-black">Mon–Fri:</strong> 6:00 AM – 6:00 PM</span>
                <span><strong className="font-semibold text-slate-black">Sat–Sun:</strong> 8:00 AM – 2:00 PM</span>
              </p>
            </motion.div>

            <motion.div variants={fadeIn}>
              <h4 className="text-sm font-bold tracking-wider text-slate-black uppercase mb-3 border-b border-forest-green pb-2 inline-block">Direct Contact</h4>
              <p className="text-gray-600 font-light flex flex-col gap-1">
                <span><strong className="font-semibold text-slate-black">Email:</strong> <a href="mailto:info@sfgeo.com.au" className="hover:text-forest-green transition-colors">info@sfgeo.com.au</a></span>
                <span><strong className="font-semibold text-slate-black">Mobile:</strong> <a href="tel:0423483555" className="hover:text-forest-green transition-colors">0423 483 555</a></span>
              </p>
            </motion.div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
            <div className="bg-slate-50 border border-gray-100 p-8 sm:p-10 rounded-2xl shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="phone" className="text-sm font-semibold text-slate-black">Contact Number</label>
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="email" className="text-sm font-semibold text-slate-black">Email</label>
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="siteAddress" className="text-sm font-semibold text-slate-black">Site Address</label>
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="message" className="text-sm font-semibold text-slate-black">Message</label>
                  <textarea id="message" name="message" rows={5} required className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-forest-green focus:border-transparent transition-all resize-none" placeholder="How can we help with your project?"></textarea>
                </div>

                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="mt-4 w-full bg-forest-green text-white font-semibold py-4 rounded-lg shadow-md hover:bg-forest-green/90 hover:shadow-lg transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                >
