...
export default function GeotechnicalReportCostPage() {
  ...
  return (
    <div className="bg-white text-slate-950 font-inter selection:bg-forest-green selection:text-white">
      ...
      <section className="pt-36 pb-20 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 className="hero-line hero-d1 text-4xl sm:text-6xl font-montserrat font-light tracking-tight leading-[1.08] mb-8">
            How Much Does A Geotechnical Report <span className="font-semibold h-bold">Cost In Sydney?</span>
          </h1>
      ...
      <section id="site-classification" className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100 scroll-mt-[90px]">
        <div className="mb-14 max-w-3xl">
          <p className="text-sm uppercase tracking-[0.2em] text-forest-green mb-4 font-semibold">01 &middot; Site Classification</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TIERS.map((c) => (
            <div key={c.k} className="flex flex-col h-full bg-white border border-gray-100 p-10 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
      ...
      <section id="what-moves-a-quote" className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100 scroll-mt-[90px]">
        <div className="mb-14 max-w-3xl">
          <p className="text-sm uppercase tracking-[0.2em] text-forest-green mb-4 font-semibold">02 &middot; What Moves A Quote</p>
          <h2 className="text-3xl sm:text-4xl font-montserrat font-light tracking-tight text-slate-950 mb-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {DRIVERS.map((d) => (
            <div key={d.t} className="p-8 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow h-full">
              <h3 className="text-lg font-montserrat font-semibold text-slate-950 mb-3">{d.t}</h3>
              <p className="text-gray-600 font-light leading-relaxed text-[15px]">{d.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* 03 — Concrete coring */}
      <section id="concrete-coring" className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100 scroll-mt-[90px]">
        <div className="max-w-3xl">
          <p className="text-sm uppercase tracking-[0.2em] text-forest-green mb-4 font-semibold">03 &middot; Concrete Coring</p>
          <h2 className="text-3xl sm:text-4xl font-montserrat font-light tracking-tight text-slate-950 mb-5">
      ...
      <section id="investigations" className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100 scroll-mt-[90px]">
        <div className="max-w-3xl">
          <p className="text-sm uppercase tracking-[0.2em] text-forest-green mb-4 font-semibold">04 &middot; Investigations, Assessments &amp; Design Parameters</p>
          <h2 className="text-3xl sm:text-4xl font-montserrat font-light tracking-tight text-slate-950 mb-5">
      ...
      {/* 05 — Turnaround */}
      <section id="turnaround" className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100 scroll-mt-[90px]">
        <div className="max-w-3xl">
          <p className="text-sm uppercase tracking-[0.2em] text-forest-green mb-4 font-semibold">05 &middot; Turnaround</p>
          <h2 className="text-3xl sm:text-4xl font-montserrat font-light tracking-tight text-slate-950 mb-5">
      ...
      {/* 06 — Common questions */}
      <section id="questions" className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100 scroll-mt-[90px]">
        <div className="mb-12 max-w-3xl">
          <p className="text-sm uppercase tracking-[0.2em] text-forest-green mb-4 font-semibold">06 &middot; Common Questions</p>
          <h2 className="text-3xl sm:text-4xl font-montserrat font-light tracking-tight text-slate-950 mb-5">
            Before You Ask. <span className="font-semibold h-bold">Straight Answers.</span>
          </h2>
          <div className="h-px bg-forest-green w-12" />
        </div>
        <dl className="max-w-3xl divide-y divide-gray-100 border-y border-gray-100">
          {FAQS.map((f) => (
      ...
      <section className="relative overflow-hidden bg-[#050A07] text-white grain">
        ...
        <div className="max-w-4xl mx-auto text-center px-6 py-28 lg:py-32 relative z-10">
          <h2 className="text-4xl sm:text-6xl font-montserrat font-light tracking-tight mb-8">
            Know The Fee <span className="font-semibold h-bold">Before The Rig.</span>
          </h2>
          <p className="text-lg sm:text-xl text-gray-400 font-light leading-relaxed max-w-2xl mx-auto mb-12">
            Send the address and what you&rsquo;re building. The Principal reads it and comes back with a fixed fee in writing within one business day.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <QuoteCta source="cost guide close" className="flex items-center justify-center px-8 py-2.5 bg-white/5 text-white rounded-full shadow-[inset_0_0_0_1px_rgba(255,255,255,0.25)] hover:bg-white/10 hover:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.45)] transition-all hover:-translate-y-0.5 w-full sm:w-[280px] h-[46px] text-xs font-semibold tracking-wide backdrop-blur-sm" />
          </div>
        </div>
      </section>
    </div>
