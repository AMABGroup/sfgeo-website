...
export default function Page() {
  ...
  const serviceSchema = {
    ...
    "description": "Footing, pier and pile inspections, proof rolls and engineered fill to AS 3798 across Sydney, verified on site and confirmed in writing before the pour.",
    ...
    <div className="bg-white text-slate-950 font-inter selection:bg-forest-green selection:text-white">
      ...
      <section className="pt-36 pb-20 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <p className="hero-line hero-d3 mt-5 text-xs text-gray-400 font-light tracking-wide">Footing and pier inspections from $600 + GST &middot; Fixed fee in writing within one business day &middot; Engineered fill supervised layer by layer to AS 3798</p>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto border-t border-gray-100">
        ...
        <Reveal variant="group">
          <div data-stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { n: "01", t: "Call Or Book", d: "Send the drawings and the excavation date. Single visits for builders, a standing schedule of rates for contractors." },
      ...
      <QuietFaq intro={<>Construction phase support is the engineer on site for builders and contractors: footing, pier and pile inspections, proof rolls and engineered fill to AS 3798. An open excavation costs money every hour it waits, so SFGEO confirms the ground against the design on site and gives the call before anyone leaves. Single visits are priced from $600 + GST, fixed in writing within one business day, and the record follows within days.</>} faqs={FAQS} />
