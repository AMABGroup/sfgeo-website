        ...
        <div className="max-w-7xl mx-auto">
          ...
          <StaggerContainer>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Card 1 */}
              <FadeInChild>
                <Link href="/contact" aria-label="Enquire about ancillary residential pricing" className="group flex flex-col h-full bg-white border border-gray-100 p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <div className="mb-4">
              ...
              {/* Card 2 */}
              <FadeInChild>
                <Link href="/contact" aria-label="Enquire about standard residential pricing" className="group flex flex-col h-full bg-white border border-gray-100 p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <div className="mb-4">
              ...
              {/* Card 3 */}
              <FadeInChild>
                <Link href="/contact" aria-label="Enquire about complex project and site pricing" className="group flex flex-col h-full bg-white border border-gray-100 p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <div className="mb-4">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-lg sm:text-xl text-gray-400 font-light leading-relaxed max-w-2xl mx-auto mb-12">
              Every SFGEO engagement begins with the Principal Engineer on your ground, reading your plans and your soil. That is where the value begins, and why the report you receive is the report your project actually needs. Detailed answers to common questions are on <Link href="/faq" className="text-white underline hover:text-gray-200 transition-colors">the full FAQ</Link>.
            </p>
