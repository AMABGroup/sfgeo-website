          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <Link href="/projects" className="text-sm leading-6 text-gray-300 hover:text-white transition-colors tracking-wide">
                      Projects
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center space-x-6">
            <div className="flex space-x-4 mr-4">
              ...
              <a href="https://instagram.com/sfgeo.syd" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#E1306C] transition-colors">
