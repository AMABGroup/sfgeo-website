      ...
      >
        <nav className="mx-auto flex max-w-[90rem] items-center justify-between px-6 lg:px-12 h-[72px]">
          ...
          <span className="hidden sm:flex items-center gap-4">
            <a href="https://au.linkedin.com/company/sfgeo" target="_blank" rel="noopener noreferrer" aria-label="SFGEO on LinkedIn" className="opacity-45 hover:opacity-90 transition-opacity">
              <svg className="w-[16px] h-[16px]" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />
                <rect width="4" height="12" x="2" y="9" />
                <circle cx="4" cy="4" r="2" />
              </svg>
            </a>
            <a href="https://instagram.com/sfgeo.syd" target="_blank" rel="noopener noreferrer" aria-label="SFGEO on Instagram" className="opacity-45 hover:opacity-90 transition-opacity">
              <svg className="w-[16px] h-[16px]" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" aria-hidden="true">
