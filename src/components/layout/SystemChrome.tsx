...
const GROUPS: { name: string; hub: string; links: { name: string; href: string }[] }[] = [
  {
    ...
    links: [
      ...
      { name: "Cost Guide", href: "/geotechnical-report-cost-sydney" },
    ],
  },
  {
    name: "Drilling",
      ...
      >
        <nav aria-label="Primary" className="mx-auto flex max-w-[90rem] items-center justify-between px-6 lg:px-12 h-[72px]">
          ...
          <span className="hidden sm:flex items-center gap-5 mr-6">
            <a href="https://www.linkedin.com/company/sfgeo" target="_blank" rel="noopener noreferrer" aria-label="SFGEO on LinkedIn (opens in a new tab)" className="inline-flex items-center justify-center p-3 -m-3 hover:opacity-70 transition-opacity">
            ...
            <a href="https://instagram.com/sfgeo.syd" target="_blank" rel="noopener noreferrer" aria-label="SFGEO on Instagram (opens in a new tab)" className="inline-flex items-center justify-center p-3 -m-3 hover:opacity-70 transition-opacity">
      ...
      <div className="max-w-[90rem] mx-auto flex flex-col gap-8">
        <div className="flex flex-wrap items-center justify-between gap-6">
          ...
          <nav aria-label="Footer" className="flex flex-wrap gap-x-7 gap-y-0 text-[13px] font-medium">
            <Link href="/services" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">Services</Link>
            <Link href="/projects" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">Projects</Link>
            <Link href="/about" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">About</Link>
            <Link href="/faq" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">FAQ</Link>
            <Link href="/geotechnical-report-cost-sydney" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">Cost Guide</Link>
            <Link href="/contact" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">Contact</Link>
            <Link href="/privacy-policy" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">Privacy</Link>
            <Link href="/terms-and-conditions" prefetch={false} className="inline-block py-3 hover:text-white transition-colors">Terms</Link>
          </nav>
        </div>
        <div className="flex flex-wrap items-center justify-between gap-4 text-[12px] font-light border-t border-white/10 pt-6">
          ...
          <p>&copy; 2025&ndash;2026 AMAB Group Pty Ltd trading as SFGEO &middot; Marrickville, Sydney &middot; ABN 54 686 815 252</p>
        </div>
      </div>
    </footer>
  );
