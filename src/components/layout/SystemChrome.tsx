      ...
      >
        <nav aria-label="Primary" className="mx-auto flex max-w-[90rem] items-center justify-between px-6 lg:px-12 h-[72px]">
          ...
          <span className="hidden sm:flex items-center gap-5 mr-6">
            <a href="https://au.linkedin.com/company/sfgeo" target="_blank" rel="noopener noreferrer" aria-label="SFGEO on LinkedIn (opens in a new tab)" className="inline-flex items-center justify-center p-3 -m-3 hover:opacity-70 transition-opacity">
